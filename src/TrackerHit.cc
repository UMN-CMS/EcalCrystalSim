...
B2TrackerHit::B2TrackerHit()
 : G4VHit(),
   ...
   fPos(G4ThreeVector())
{
	//outtreeHit = new TTree("hit1GeV", "1GeV");
	//outtreeHit->Branch("trackID", &fTrackID, "trackID/I");
	//outtreeHit->Branch("crystNum", &fChamberNb, "crystNum/I");
	//outtreeHit->Branch("deltE", &mdeltE, "deltE/F");
	//outtreeHit->Branch("xpos", &mxpos, "xpos/F");
	//outtreeHit->Branch("ypos", &mypos, "ypos/F");
	//outtreeHit->Branch("zpos", &mzpos, "zpos/F");
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

B2TrackerHit::~B2TrackerHit() {
	//TFile* out = new TFile("/home/crystSim/TreeDataStorage/1GeV_hits", "RECREATE");
	//outtreeHit->Write();
	//out->Close();
	//eventNum = -1;
	//delete outtreeHit;
